...
<form action="${pageContext.request.contextPath}/ny/employersvl" method="post" name="employerinfo">
  ...
  <table width="96%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#bdc7d3" class="text_lb">
    <tr>
      ...
      <td width="17%" bgcolor="#FFFFFF"><input type="radio" name="radio" id="radio12" value="M">
男
  <input type="radio" name="radio" id="radio13" value="W">
女</td>
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><input name="textarea111" type="text" id="textarea11" value="" size="15" class="pi"></td>
    </tr>
    <tr>
    ...
    <tr>
	 ...
	 <tr>
      ...
      <td colspan="2" align="left" bgcolor="#FFFFFF">从
        <input name="textarea11" type="text" id="textarea20" value="" size="8" class="pi">
      到
      ...
      <td colspan="7" bgcolor="#FFFFFF"><input type="checkbox" name="checkbox4" id="checkbox" value="月嫂" />
        月嫂
&nbsp;
<input type="checkbox" name="checkbox" id="checkbox1" value="保姆"/>
保姆&nbsp;&nbsp;
<input type="checkbox" name="checkbox" id="checkbox2" value="钟点"/>
钟点&nbsp;&nbsp;
<input type="checkbox" name="checkbox" id="checkbox3" value="厨嫂"/>
厨嫂
<input type="checkbox" name="checkbox" id="checkbox4" value="清洁工"/>
清洁工
&nbsp;
...
家教
&nbsp;&nbsp;
<input type="checkbox" name="checkbox" id="checkbox8" value="高级管家"/>
高级管家<br>
备注：
<input name="textarea99" type="text" id="textarea99" value="" size="40" class="pi"></td>
    </tr>
    <tr>
