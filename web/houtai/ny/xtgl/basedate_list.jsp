...
<br/>
<form id="form1" action="${pageContext.request.contextPath}/houtai/sjzdSvl?reqType=queryByCritria" method="post">
          ...
          <table width="90%" style="font-size:12px;" border="0" cellspacing="3" cellpadding="2">
            <tr>
              ...
              <td nowrap width="55%" align="right"><input type="hidden" name="currentPage" value="1">
                  ...
                  <img src="../image/Next_no.gif" alt="下一页" width="14" height="13" border="0" onclick="location.href='${pageContext.request.contextPath}/houtai/sjzdSvl?reqType=queryAll&pageNow=${pageNow+1}'">&nbsp;&nbsp;&nbsp;
