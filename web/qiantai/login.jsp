...
<div class="usBox clearfix">
	<div class="usBox_1 f_l">
		...
		<form name="formLogin" action="${pageContext.request.contextPath}/qiantai/usersvl" method="post">
			...
			<table width="150%" border="0" align="left" cellpadding="3" cellspacing="5">
				<tr>
				...
				<tr>
					<td align="right" width="20" style="position: relative;top: 5px">验证码</td>
					<td>
						<input name="validateCode" type="text" size="5"/>
					    <img id="validateImg" src="usersvl?reqType=validate" width="90" height="20" style="position: relative;top: 8px"/>
						<input type="button"  value="看不清" onclick="getCode()" />
						${info}
					</td>
				</tr>
				<tr>
