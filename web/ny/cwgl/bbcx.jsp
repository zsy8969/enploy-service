          ...
          <table width="90%" style="font-size:12px;" border="0" cellspacing="3" cellpadding="2">
            <tr>
              ...
              <td nowrap width="55%" align="right"><input type="hidden" name="currentPage" value="1">
                  ...
                  <img src="../image/First_no.gif" alt="第一页" width="18" height="13" border="0" onclick="location.href='../houtai/xfglSvl?reqType=queryAll&pageNow=1'">&nbsp;&nbsp;&nbsp;
                  <img src="../image/Previous_no.gif" alt="上一页" width="14" height="13" border="0" onclick="location.href='../houtai/xfglSvl?reqType=queryAll&pageNow=${pageNow-1}'">&nbsp;&nbsp;&nbsp;
                  <img src="../image/Next_no.gif" alt="下一页" width="14" height="13" border="0" onclick="lastPage()">&nbsp;&nbsp;&nbsp;
                  <img src="../image/Last_no.gif" alt="最后一页" width="18" height="13" border="0" onclick="location.href='../houtai/xfglSvl?reqType=queryAll&pageNow=${totalPages}'">&nbsp;&nbsp;&nbsp;
...
<script>
    function gotoPage() {
        ...
        if (page != 0) {
            window.location.href="${pageContext.request.contextPath}/houtai/xfglSvl?reqType=queryAll&pageNow="+page;
        }else {
            window.location.href="${pageContext.request.contextPath}/houtai/xfglSvl?reqType=queryAll&pageNow="+${pageNow};
        }
    }
    ...
    function lastPage() {
        ...
        if (pageNow == totalPages) {
            ...
            window.location.href="../houtai/xfglSvl?reqType=queryAll&pageNow=${pageNow+1}";
        }
    }
</script>
</html>
