...
<br/>
  ...
  <table width="96%" height="30" border="0" align="center" cellpadding="0" cellspacing="0" class="MENU_line">
    <tr>
      <td width="67%" align="right" class="text" nowrap>&nbsp;姓名：
        ...
        <input type="submit" name="searchbtn2" value="新  增" class="button_new"onClick="javascript:location.href='grxx_xz.htm'" >
  ...
  <table width="96%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#bdc7d3">
    ...
    <tr align="center" class="td2"  onmouseover="javascript:changeBgColorOnMouseOver(this);" onMouseOut="javascript:changeBgColorOnMouseOut(this);" onDblClick="doDBClick('bl.htm',true,'2');">
      <td nowrap align="center" width="3%">${worker.index} </td>
      <td align="center" nowrap>${worker.work_name}</td>
      <td height="14" align="center" nowrap>${worker.sex}</td>
      <td align="center" nowrap>${worker.age}</td>
      <td align="left" nowrap>${worker.work_type}</td>
      <td align="center" nowrap>${worker.price_re}</td>
      <td align="center" nowrap>${worker.statu}</td>
      <td align="center" nowrap>${worker.enter_time}&nbsp; </td>
