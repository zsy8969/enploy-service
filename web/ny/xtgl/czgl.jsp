...
<form method="post" action="${pageContext.request.contextPath}/ny/employersvl">
    <input type="hidden" name="reqType" value="queryRechargeByParam">
 ...
 &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <table width="96%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#bdc7d3">
    <tr align="center" class="tdtitle">
      ...
      <td width="9%" align="center" nowrap id="1name" >刷卡次数</td>
      <td width="7%" align="center" nowrap id=".2name" >收费标准<strong>(元/次)</strong></td>
      <td width="12%" height="24" align="center" nowrap id=".3name" ><div align="center" orderBy="true"><strong>合计消费额(元)</strong></div></td>
    ...
    <tr align="center" class="td2"  onmouseover="javascript:changeBgColorOnMouseOver(this);" onMouseOut="javascript:changeBgColorOnMouseOut(this);" onDblClick="doDBClick('bl.htm',true,'2');">
      <td nowrap align="center" width="3%">${recharge.index} </td>
      <td align="center" nowrap>${recharge.company_name}</td>
      <td align="center" nowrap>${recharge.company_account}</td>
      <td align="center" nowrap>${recharge.cash_amount}</td>
      <td align="center" nowrap>${recharge.cash_money}</td>
      <td height="14" align="center" nowrap>${recharge.cash_all}</td>
      <td align="center" nowrap>${recharge.cash_balabce}</td>
      <td align="center" nowrap>${recharge.operator}</td>
      <td align="center" nowrap>${recharge.record}</td>
      <td align="center" nowrap><a href="${pageContext.request.contextPath}/ny/xtgl/czgl_xz.jsp?name=${recharge.company_name}&company_id=${recharge.company_id}">充值</a></td>
    </tr>
    </c:forEach>
