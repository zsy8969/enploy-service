...
<form method="post" action="${pageContext.request.contextPath}/ny/employersvl">
    <input type="hidden" name="reqType" value="queryCashByParam">
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;日期：
  ...
  <table width="96%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#bdc7d3">
    <tr align="center" class="tdtitle">
      ...
      <c:forEach items="${queryCashes}" var="cash">
    <tr align="center" class="td2"  onmouseover="javascript:changeBgColorOnMouseOver(this);" onMouseOut="javascript:changeBgColorOnMouseOut(this);" onDblClick="doDBClick('bl.htm',true,'2');">
      <td width="4%" height="14" align="center" nowrap>${cash.index} </td>
      <td align="center" nowrap>${cash.company_name} </td>
      <td align="center" nowrap>${cash.company_aacount} </td>
      <td align="center" nowrap>${cash.cash_time} </td>
      <td align="center" nowrap>${cash.cash_price} </td>
    </tr>
      </c:forEach>
