...
<br/>
<br>
<form action="${pageContext.request.contextPath}/houtai/gsglSvl?reqType=mod" method="post">
  ...
  <table width="96%" height="49" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#bdc7d3" class="text_lb">
    <tr>
      ...
      <td width="435" bgcolor="#FFFFFF"><input name="account" type="text" id="textarea1" value="${param.account}" size="30" class="pi"></td>
      <td width="176" align="right" bgcolor="#FFFFFF">名称：</td>
      <td width="509" bgcolor="#FFFFFF">
      	<input name="name" type="text" id="textarea2" value="${param.name}" size="30" class="pi">
      
      </td>
    </tr>
    <tr>
      <td height="23" align="right" bgcolor="#FFFFFF">简介：</td>
      <td colspan="3" bgcolor="#FFFFFF"><textarea name="intro" id="textarea3" cols="45" rows="5">${param.intro}</textarea></td>
    </tr>
  </table>
